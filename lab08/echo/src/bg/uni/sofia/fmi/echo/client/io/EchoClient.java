package bg.uni.sofia.fmi.echo.client.io;
...
import bg.uni.sofia.fmi.echo.server.io.EchoServer;
 ...
 * data.
 * 
 * Hint: The client can be improved by enabling him to simultaneously read from
...
public class EchoClient {
	 ...
	 */
	public EchoClient(InetAddress host, int port) {
	...
	public static void main(String[] args) throws UnknownHostException {
		EchoClient ec = new EchoClient(InetAddress.getLocalHost(), EchoServer.SERVER_PORT);
		ec.start();
	}
